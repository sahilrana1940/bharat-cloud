...
button{background:#00d1ff;border:none;padding:12px 25px;border-radius:8px;font-weight:bold}
...
def home():
    files_html = ""
    if not supabase:
        files_html = "<p style='color:orange'>Vercel pe SUPABASE keys add karo</p>"
    else:
        try:
